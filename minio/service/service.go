...
func (srv *MinioService) Configure(jwtKey string) error {
...
func (srv *MinioService) Authorize(context *gin.Context) *models.User {
...
func (srv *MinioService) GetTokenClaims(context *gin.Context) (*jwt.JWTClaim, error) {
