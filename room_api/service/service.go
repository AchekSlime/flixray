...
func (srv *RoomService) Configure(jwtKey string) error {
...
func (srv *RoomService) Authorize(context *gin.Context) *models.User {
...
func (srv *RoomService) GetTokenClaims(context *gin.Context) (*jwt.JWTClaim, error) {
